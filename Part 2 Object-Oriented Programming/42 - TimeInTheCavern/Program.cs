    ...
    public void RunGame()
    {
        ...
        while (true)
        {
            ...
            if (IsGameWin(player, gameTable))
            {
                ...
                Console.WriteLine($"You took {timeCounter.GetConclusionTime().Minutes} minutes and {timeCounter.GetConclusionTime().Seconds} seconds to conclude the game!");
                Console.ForegroundColor = ConsoleColor.White;
                break;
            }
...
public class TimeHandler
{
    ...
    private TimeSpan conclusionTime;


    public TimeSpan GetConclusionTime()
    {
        conclusionTime = DateTime.Now - startTime;
